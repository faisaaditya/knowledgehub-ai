  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-500">Kelola berkas dokumen dan lihat aktivitas chatbot tim Anda.</p>
      </div>
      ...
      <div className="mt-8">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold text-gray-800">Daftar Dokumen</h2>
